use anyhow::Result;
use bytes::Bytes;
use filesynchub::plugins::onedrive::OneDrivePlugin;
use filesynchub::plugins::Plugin;
use std::path::Path;

#[tokio::main]
async fn main() -> Result<()> {
    // Create a new OneDrive plugin instance
    let plugin = OneDrivePlugin::new("FileSyncHub".to_string());

    // Test the connection
    println!("Testing connection to OneDrive...");
